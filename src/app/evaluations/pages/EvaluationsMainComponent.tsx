          ...
          {showFilters && (
            <>
              ...
              >
                ...
                >
                  <Typography variant="h3">{t("Filter_Settings")}</Typography>
                </Box>

                <FilterContainerComponent
                  selectionConfig={model.selectionConfig}
                  searchButtonText={model.searchButtonText}
                  handleSearchBtnClick={(data: FilterSelection) => {
              ...
              Object.keys(model.evaluationsData)
                ...
                .map((division) => (
                  <EvaluationDivisionContainer
                    ...
                    downloadGraphButtonText={model.downloadGraphButtonText}
                    downloadDataButtonText={model.downloadDataButtonText}
                  ></EvaluationDivisionContainer>
                ))}
          </div>
        </Item>
